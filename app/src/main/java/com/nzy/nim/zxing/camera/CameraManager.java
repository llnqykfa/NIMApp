...
package com.nzy.nim.zxing.camera;
...
//	private static final int MAX_FRAME_HEIGHT = 400;
	...
	private static int MIN_FRAME_WIDTH = 500;
	private static int MIN_FRAME_HEIGHT = 500;
	private static int MAX_FRAME_WIDTH = 650;
	private static int MAX_FRAME_HEIGHT = 550;
	...
	public static void init(Context context) {
		...
		}else if(screenWidth >=620&&screenWidth<1000){

			MIN_FRAME_WIDTH = 500;
			MIN_FRAME_HEIGHT = 500;
			MAX_FRAME_WIDTH = 650;
			MAX_FRAME_HEIGHT = 550;

		}else if(screenWidth <= 620){
			MIN_FRAME_WIDTH = 350;
			MIN_FRAME_HEIGHT = 350;
			MAX_FRAME_WIDTH = 500;
