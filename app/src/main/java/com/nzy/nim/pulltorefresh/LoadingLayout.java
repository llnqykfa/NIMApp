...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public void show(boolean show) {
		...
		if (params != null) {
			...
			setVisibility(show ? View.VISIBLE : View.INVISIBLE);// 如果show为true的话显示，false隐藏
		}
	}
	...
	/**
	 * 设置当前状态：判断当前状态是否有改变，如果有改变的话讲当前的状态赋给上一个状态，自己则变为改变后的状态
	 */
	@Override
	...
	protected void onStateChanged(State curState, State oldState) {
		...
		case RELEASE_TO_REFRESH:// 松手刷新
			onReleaseToRefresh();
			break;

		case PULL_TO_REFRESH:// 下拉中……
			onPullToRefresh();
			break;
