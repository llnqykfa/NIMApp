...
import com.nzy.nim.adapter.ViewPager_GV_ItemAdapter;
import com.nzy.nim.adapter.ViewPager_GridView_Adapter;
...
//        pageItemCount = col * row;  //每一页可装item
        ...
        if (0 < viewPager_size) {
            ...
            if (1 == viewPager_size) {
                ...
                for (int j = 0; j < viewPager_size; j++) {
                    ...
                    LayoutParams params = new LayoutParams(10, 10);  //dot的宽高
        ...
        if (viewPager_size != 1) {
            ...
            dots[currentIndex].setBackgroundResource(R.drawable.d2);
    ...
    private void setCurDot(int positon) {
        ...
        for(int i=0;i<dots.length;i++){
            dots[i].setBackgroundResource(R.drawable.d1);
        }
        //dots[positon].setEnabled(false);
        // dots[currentIndex].setEnabled(true);
        dots[positon].setBackgroundResource(R.drawable.d2);
